...
import graphChart from './graph/index';
...
var testBox = function () {
  var canvas = document.getElementById("catch");
  ...
  var Game = {
    init: function () {
      for (var i = 0; i < 1000; i++) {
        var b = new Ball(getRandom(0, canvas.width), getRandom(0, canvas.height), getRandom(-10, 10),
